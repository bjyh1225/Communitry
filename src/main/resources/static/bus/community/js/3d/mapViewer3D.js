var mapViewer3D = (function () {
    ...
    map.renderP(viewer, featherCmsScript.ctx +'bus/community/json/SQ_M.json', '#4BE1EE');
    map.renderP(viewer, featherCmsScript.ctx +'bus/community/json/XQ_M.json', '#3CBF9C');

    map.addLayerName(viewer, featherCmsScript.ctx +'bus/community/json/SQ_D.json','SQ');
    map.addLayerName(viewer, featherCmsScript.ctx +'bus/community/json/XQ_D.json','XQ');
    return {
        viewer: viewer
    };
})();

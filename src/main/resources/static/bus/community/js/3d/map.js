var map = {
    ...
    addLayerPic: function (type) {
        ...
        if (type == 'SXT') {
            id = 'SXTID';
            url = 'bus/community/json/SXT.json';
            img = 'bus/community/img/camera-selected.png';
        } else if (type == 'MJ') {
            id = 'MJID';
            url = 'bus/community/json/MJ.json';
            img = 'bus/community/img/door-selected.png';
        } else if (type == 'ZJ') {
            id = 'ZJID';
            url = 'bus/community/json/ZJ.json';
            img = 'bus/community/img/zj-selected.png';
        } else if (type == 'DG') {
            id = 'DGID';
            url = 'bus/community/json/DG.json';
            img = 'bus/community/img/dg-selected.png';
        } else if (type == 'LJT') {
            id = 'LJTID';
            url = 'bus/community/json/LJT.json';
            img = 'bus/community/img/ljt-selected.png';
        } else if (type == 'YG') {
            id = 'YGID';
            url = 'bus/community/json/YG.json';
            img = 'bus/community/img/smoke-selected.png';
        } else if (type == 'CDZ') {
            id = 'CDZID';
            url = 'bus/community/json/CDZ.json';
            img = 'bus/community/img/cdz.png';
        } else if (type == 'LD') {
            id = 'LDID';
            url = 'bus/community/json/ZNLD.json';
            img = 'bus/community/img/light-selected.png';
        } else if (type == 'XFS') {
            id = 'XFSID';
            url = 'bus/community/json/XFS.json';
            img = 'bus/community/img/xfs-selected.png';
        } else if (type == 'YC') {
            id = 'YCID';
            url = 'bus/community/json/YC.json';
            img = 'bus/community/img/warn-selected.png';
        } else if (type == 'FW') {
            id = 'LDID';
            url = 'bus/community/json/LD_D.json';
            img = 'bus/community/img/xq-selected.png';
        } else if (type == 'RY') {
            id = 'LDID';
            url = 'bus/community/json/LD_D.json';
            img = 'bus/community/img/xq.png';
        }

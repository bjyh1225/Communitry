    ...
    onLoad: function (cmsOptions) {
        var mapObject = {
            ...
            otherClick: function (id, type, typeObject) {
                ...
                featherCmsScript._map.addBoxByEntity(id)
            },
            // 设置模型颜色渲染
            setmodalEntitiesStyle:function(color) {
                mapObject.tileset.style = new Cesium.Cesium3DTileStyle({
                    color : color,
                    show : true
            ...
            // 盒子颜色
            addBoxByEntity:function (id) {
                $.ajax({
                    "async": false,
                    "url": featherCmsScript.ctx + 'bus/community/json/location.json',
                    "type": 'GET',
                    "dataType": 'json',
                    "success": function (data) {
                        featherCmsScript._map.setmodalEntitiesStyle('color(\'white\', 0.3)');
                        if(mapObject.cooridor){
                            mapObject.viewer.entities.remove(mapObject.cooridor);
                        }
                        ...
                        mapObject.cooridor = mapObject.viewer.entities.add({//红色多边形
                        ...
                        mapObject.viewer.flyTo(mapObject.cooridor, {
                            offset: {
                                heading: Cesium.Math.toRadians(0.0),
        ...
        mapObject.renderP('bus/community/json/SQ_M.json', '#4BE1EE');
        mapObject.renderP('bus/community/json/XQ_M.json', '#3CBF9C');
        mapObject.addLayerName('bus/community/json/SQ_D.json', 'SQ');
        mapObject.addLayerName('bus/community/json/XQ_D.json', 'XQ');
        ...
        function addflst () {
            var url = featherCmsScript.ctx + 'bus/community/gltf/Surface_À³Òð·çÉÐ_0.gltf';
...
var trackPlayback = {
    ...
    start: function (data) {debugger
        ...
        var options = {
            billboard: {
                image: featherCmsScript.ctx + 'bus/community/img/xunjiandian.png',
                width: 48,
                height: 48,
    ...
    play: function (historyGeoData) {
        ...
        this.historyPathEntity = featherCmsScript._map.viewer.entities.add({
            ...
            billboard: {
                image: featherCmsScript.ctx + 'bus/community/img/xunjianrenyuan.png',
                horizontalOrigin: Cesium.HorizontalOrigin.CENTER,
                verticalOrigin: Cesium.VerticalOrigin.BOTTOM
            },

...
var sqglCw = {
	...
	getSqglCwInfo : function (sqId,xqId) {
        ...
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getCwInfoLeft?sqid=' + sqId + '&xqid=' + xqId,
            type: 'GET',
            dataType: 'json',
    ...
    getTccNum : function(sqid,xqid,tccmc){
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getTccInfoRight?sqid=' + sqid + '&xqid=' + xqid + '&tccmc=' + tccmc + '&pageNum=' + pageNum + '&pageSize=' + pageSize,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
            	debugger;
	...
	getTccXxInfo : function(tccIdLx){
        ...
        featherCmsScript._map.replacePic('bus/community/img/p.png', arr[0]);
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getTccXxInfoCenter?tccId=' + tccIdLx,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                debugger;
    ...
    getKxcwInfo : function (sqid,xqid,cwid){
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getKxcwInfo?sqid=' + sqid + '&xqid=' + xqid + '&cwid=' + cwid + '&pageNum=' + pageNum + '&pageSize=' + pageSize,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                debugger;
    ...
    getKxcwXxInfoList : function(cwxx){
        ...
        featherCmsScript._map.replacePic('bus/community/img/p.png', split[2]);
        var cwidClick = split[0];
        var cwidClick = cwidClick.substring(cwidClick.length-4,cwidClick.length);

        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getKxcwXxInfoList?cwxx=' + cwxx + '&sqid=' + sqid+ '&xqid=' + xqid,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                debugger;
    ...
    getYycwInfo : function (sqid,xqid,cwid){
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getYycwInfo?sqid=' + sqid + '&xqid=' + xqid + '&cwid=' + cwid + '&pageNum=' + pageNum + '&pageSize=' + pageSize,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                debugger;
    ...
    getYycwXxInfoList : function(cwxx){
        ...
        $.ajax({
            async: false,
            url: featherCmsScript.ctx + 'community/CW/getYycwXxInfoList?cwxx=' + cwxx + '&sqid=' + sqid+ '&xqid=' + xqid,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                debugger;
...
function sbxxx1(type,data) {
    var img;
        if (type == 'SXT') {
            img = 'bus/community/img/camera.png';
        } else if (type == 'MJ') {
            img = 'bus/community/img/door.png';
        } else if (type == 'ZJ') {
            img = 'bus/community/img/zj.png';
        } else if (type == 'DG') {
            img = 'bus/community/img/dg.png';
        } else if (type == 'LJT') {
            img = 'bus/community/img/ljt.png';
        } else if (type == 'YG') {
            img = 'bus/community/img/smoke.png';
        } else if (type == 'CDZ') {
            img = 'bus/community/img/cdz.png';
        } else if (type == 'LD') {
            img = 'bus/community/img/light.png';
        } else if (type == 'XFS') {
            img = 'bus/community/img/xfs.png';
        } else if (type == 'YC') {
            img = 'bus/community/img/warn.png';
        }
